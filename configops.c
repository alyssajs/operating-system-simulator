...
Preconditon: configData holds allocated data set
...
Precondition: code variable holds constant value from ConfigDataCodes
              for item (e.g., CPU_SCHED_STRF_P, LOGTO_FILE_CODE, etc.)
...
void configCodeToString( int code, char *outString )
   {
      ...
      char displayStrings[ 8 ][ 10 ] = { "SJF_N", "SRTF-P", "FCFS-P",
                                         "RR-P", "FCFS-N", "Monitor",
                                         "File", "Both" };
...
Exceptions: correctly and appropriately (without program failure) 
            ...
            and incompltete file conditions
Notes: none
*/
...
Postcondition: returns line number of data item in terms of a constant
               (e.g., CFC_VERSION_CODE, CFG_CPU_SCHED_CODE, etc.)
Exceptions: returns CFG_CORRPUT_FILE_ERR if string is not identified
Notes: none
*/
...
Postcondition: returns code representing log to actoins
Exceptions: defaults to monitor code
Notes: none
*/
